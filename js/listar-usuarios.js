...
.then(function (response) {
    ...
    for (let usuario of data) {
        ...
        //'<td><img src=https://www.pythonanywhere.com/user/USUARIO/files/home/USUARIO/mysite
        // /static/imagenes/' + usuario.imagen_url +' alt="Imagen del usuario"
        //style="width: 100px;"></td>' + '<td align="right">' + usuario.proveedor + '</td>';
